...
public class ExecutableReference {
    ...
    protected void writeInitialElements(WriteContext ctx) {
        if ((this.access() & ACC_STATIC) == 0) {
            ...
            m.visitMethodInsn(INVOKESTATIC, Owners.SUPER_USERDATA_FACTORY, "from", "(Lme/basiqueevangelist/enhancedreflection/api/EClass;)Ldev/moongarden/allium/loader/type/userdata/SuperUserdataFactory;", false); // superUDF
            m.visitVarInsn(ALOAD, 0); // superUDF, this
            m.visitMethodInsn(INVOKEVIRTUAL, Owners.SUPER_USERDATA_FACTORY, "create", "(Ljava/lang/Object;)Ldev/moongarden/allium/loader/type/userdata/SuperUserdata;", false); // superLuaValue
            m.visitTypeInsn(CHECKCAST, Owners.SUPER_USERDATA);
            ctx.fields().get(m, eClass); // superLuaValue, thisEClass
            m.visitMethodInsn(INVOKESTATIC, Owners.PRIVATE_USERDATA_FACTORY, "from", "(Lme/basiqueevangelist/enhancedreflection/api/EClass;)Ldev/moongarden/allium/loader/type/userdata/PrivateUserdataFactory;", false); // superLuaValue, privateUDF
            m.visitVarInsn(ALOAD, 0); // superLuaValue, privateUDF, this
            m.visitMethodInsn(INVOKEVIRTUAL, Owners.PRIVATE_USERDATA_FACTORY, "create", "(Ljava/lang/Object;)Ldev/moongarden/allium/loader/type/userdata/PrivateUserdata;", false); // superLuaValue, privateLuaValue
            ...
            m.visitMethodInsn(INVOKEVIRTUAL, Owners.PRIVATE_USERDATA, "applySuperInstance", "(Ldev/moongarden/allium/loader/type/userdata/SuperUserdata;)V", false); //
        }
    }
